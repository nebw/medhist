...
from ehrgraphs.layers.activations import GEGLU
...
class MLPHead(torch.nn.Module):
    def __init__(
        ...
        if norm is not None and initial_norm:
        ...
        self.use_final_layer_bias = use_final_layer_bias
        self.out = torch.nn.Linear(num_hidden, num_endpoints, bias=use_final_layer_bias)
